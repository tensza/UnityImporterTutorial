...
namespace Articy.UnityImporterTutorial
{
    ...
    public class DefaultSupportingCharacterTemplate : Entity, IEntity, IPropertyProvider, IObjectWithFeatureDefaultBasicCharacterFeature
    {
        ...
        private static Articy.UnityImporterTutorial.Templates.DefaultSupportingCharacterTemplateTemplateConstraint mConstraints = new Articy.UnityImporterTutorial.Templates.DefaultSupportingCharacterTemplateTemplateConstraint();
        
        public Articy.UnityImporterTutorial.Templates.DefaultSupportingCharacterTemplateTemplate Template
        {
            get
            {
        ...
        public static Articy.UnityImporterTutorial.Templates.DefaultSupportingCharacterTemplateTemplateConstraint Constraints
        {
            get
            {
                return mConstraints;
        ...
        protected override void CloneProperties(object aClone, Articy.Unity.ArticyObject aFirstClassParent)
        {
            ...
            if ((Template != null))
            {
                newClone.Template = ((Articy.UnityImporterTutorial.Templates.DefaultSupportingCharacterTemplateTemplate)(Template.CloneObject(newClone, aFirstClassParent)));
            }
