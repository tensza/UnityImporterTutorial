...
namespace Articy.UnityImporterTutorial
{
    ...
    public class DefaultMainCharacterTemplate : Entity, IEntity, IPropertyProvider, IObjectWithFeatureDefaultExtendedCharacterFeature, IObjectWithFeatureDefaultBasicCharacterFeature
    {
        ...
        private static Articy.UnityImporterTutorial.Templates.DefaultMainCharacterTemplateTemplateConstraint mConstraints = new Articy.UnityImporterTutorial.Templates.DefaultMainCharacterTemplateTemplateConstraint();
        
        public Articy.UnityImporterTutorial.Templates.DefaultMainCharacterTemplateTemplate Template
        {
            get
            {
        ...
        public static Articy.UnityImporterTutorial.Templates.DefaultMainCharacterTemplateTemplateConstraint Constraints
        {
            get
            {
                return mConstraints;
        ...
        protected override void CloneProperties(object aClone, Articy.Unity.ArticyObject aFirstClassParent)
        {
            ...
            if ((Template != null))
            {
                newClone.Template = ((Articy.UnityImporterTutorial.Templates.DefaultMainCharacterTemplateTemplate)(Template.CloneObject(newClone, aFirstClassParent)));
            }
